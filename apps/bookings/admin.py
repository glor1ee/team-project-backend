...
class BookingAdmin(admin.ModelAdmin):
    ...
    def apply_instagram_discount(self, request, queryset):
        ...
        for booking in queryset:
            subtotal = booking.price_per_day * booking.rental_days + booking.delivery_fee
            booking.discount_amount = (subtotal * Decimal("0.10")).quantize(Decimal("0.01"))
